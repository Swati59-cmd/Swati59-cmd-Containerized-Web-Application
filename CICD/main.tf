...
resource "aws_codebuild_project" "my_builddemo" {
  name         = "${var.env}-CodeBuildProjectdemo"
...
resource "aws_codepipeline" "my_pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ProjectName = aws_codebuild_project.my_builddemo.name
      }
    }
  }
